module raider.engine.render.window;
...
{private:
	...
	vec4 _viewport;
	static W!Window _activeWindow; ///The window active in this thread.
	bool _closeRequested;

public:
	@property static W!Window activeWindow() { return _activeWindow; }
	...
	void bind()
	{
		...
		{
			if(sfWindow_setActive(sfwindow, true)) _activeWindow = W!Window(this);
