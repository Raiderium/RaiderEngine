 ...
 * 
 * There are many animated types. Curve provides
 * common timing and sorting behaviour which can 
 * then be encapsulated by other animation tools.
 */
class Curve
{
private:
	...
	Point[] points;	//TODO Replace with Array template
...
public:
	...
	///The current time cursor of the curve.
	@property float time() { return t; }
	///ditto
	@property void time(double value) { addTime(value - t); }
